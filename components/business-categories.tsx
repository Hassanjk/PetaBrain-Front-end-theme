  ...
  return (
    <section>
        <div className="text-center">
              ...
              data-aos="zoom-y-out"
              data-aos-delay={50}>Use  by the most innovative minds in <span className="text-indigo-500 inline-flex flex-col h-[calc(theme(fontSize.3xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] overflow-hidden">
                    <ul className="block animate-text-slide-5 text-left leading-tight [&_li]:block">
                        <li>gpt-4 API's</li>
                        <li>Gemini Pro Api</li>
                        <li>Claude Api</li>
                        <li>Azure Api</li>
                        <li>Baidu Api</li>
                        <li aria-hidden="true">Alibaba Api</li>
                    </ul>
                </span></div>
            </div>
